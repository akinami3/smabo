            ...
            try:
                ...
                while True:
                    ...
                    if key == "w": # 前進
                        ...
                        self.current_state = DcMotor.CURVE_RIGHT_FRONT
                    elif key == "c": # 右カーブ（後退）
                        self.current_state = DcMotor.CURVE_RIGHT_BACK
                    elif key == "q": # 左カーブ（全身）
                        self.current_state = DcMotor.CURVE_LEFT_FRONT
                    elif key == "z": # 左カーブ（後退）
                        self.current_state = DcMotor.CURVE_LEFT_BACK
                    elif key == "r": # 速度上昇
